...
<p align="center">
  <a href="https://github.com/EmpRider/codex-chatgpt-web/releases/download/v5.0.12/codex-web-gpt-5.0.12-mac-x64.dmg">macOS Intel</a> · <a href="https://github.com/EmpRider/codex-chatgpt-web/releases/latest">すべてのリリース</a>
</p>
...
[トラブルシューティング](TROUBLESHOOTING.md) · [セキュリティ](SECURITY.md) · [コントリビューション](CONTRIBUTING.md) · [MIT ライセンス](LICENSE) · [CI](https://github.com/EmpRider/codex-chatgpt-web/actions/workflows/ci.yml)
