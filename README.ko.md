...
<p align="center">
  <a href="https://github.com/EmpRider/codex-chatgpt-web/releases/download/v5.0.14/codex-web-gpt-5.0.14-mac-x64.dmg">macOS Intel</a> · <a href="https://github.com/EmpRider/codex-chatgpt-web/releases/latest">모든 릴리스</a>
</p>
...
[문제 해결](TROUBLESHOOTING.md) · [보안](SECURITY.md) · [기여](CONTRIBUTING.md) · [MIT 라이선스](LICENSE) · [CI](https://github.com/EmpRider/codex-chatgpt-web/actions/workflows/ci.yml)
