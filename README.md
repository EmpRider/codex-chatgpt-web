...
<p align="center">
  <a href="https://github.com/EmpRider/codex-chatgpt-web/releases/download/v6.1.3/codex-web-gpt-6.1.3-win-x64.exe"><img src="assets/readme/download-windows.svg" width="224" height="64" alt="Windows · x64"></a>&nbsp;
  <a href="https://github.com/EmpRider/codex-chatgpt-web/releases/download/v6.1.3/codex-web-gpt-6.1.3-mac-arm64.dmg"><img src="assets/readme/download-macos.svg" width="224" height="64" alt="macOS · Apple silicon"></a>&nbsp;
  <a href="https://github.com/EmpRider/codex-chatgpt-web/releases/download/v6.1.3/codex-web-gpt-6.1.3-linux-x64.AppImage"><img src="assets/readme/download-linux.svg" width="224" height="64" alt="Linux · x64"></a>
</p>

<p align="center">
  <a href="https://github.com/EmpRider/codex-chatgpt-web/releases/download/v6.1.3/codex-web-gpt-6.1.3-mac-x64.dmg">macOS Intel</a> · <a href="https://github.com/EmpRider/codex-chatgpt-web/releases/latest">All releases</a>
</p>
...
```bash
curl -fsSL https://github.com/EmpRider/codex-chatgpt-web/releases/latest/download/install-launcher.sh | sh
```

**Windows PowerShell**

```powershell
irm https://github.com/EmpRider/codex-chatgpt-web/releases/latest/download/install-launcher.ps1 | iex
```
...
heavy rendered DOM is removed. Disable it from Settings if you need the complete rendered
transcript; this option does not affect Zero Risk/manual chats.
...
```bash
git clone https://github.com/EmpRider/codex-chatgpt-web.git && \
...
[Troubleshooting](TROUBLESHOOTING.md) · [Security](SECURITY.md) · [Contributing](CONTRIBUTING.md) · [MIT license](LICENSE) · [CI](https://github.com/EmpRider/codex-chatgpt-web/actions/workflows/ci.yml)
